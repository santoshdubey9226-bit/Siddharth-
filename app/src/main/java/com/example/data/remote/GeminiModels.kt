...
/**
 * Gemini API Request and Response Data Transfer Objects.
 *
 * Configured according to the official Google Gemini v1beta REST specification.
 */
...
data class GeminiInlineData(
    ...
    @Json(name = "data") val data: String // Base64 encoded bytes
)
